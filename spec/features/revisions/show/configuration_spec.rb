feature 'Revision coverage' do
    ...
    feature 'Site settings' do
        ...
        feature 'Browser' do
            ...
            feature 'Fingerprinting' do
                before do
                    revision.site_profile.browser_cluster_ignore_images = true
                    revision.site_profile.save

                    refresh
                end

                let(:attribute) { 'browser_cluster_ignore_images' }
                ...
                feature 'when false' do
                    before do
                        revision.site_profile.browser_cluster_ignore_images = false
                        revision.site_profile.save
                ...
                feature 'when identical to the snapshot' do
                    before do
                        site.profile.browser_cluster_ignore_images =
                            revision.site_profile.browser_cluster_ignore_images
                        site.profile.save
                ...
                feature 'when different from the snapshot' do
                    before do
                        site.profile.browser_cluster_ignore_images = false
                        site.profile.save
                    ...
                    scenario 'Revert button sets Site options to Revision options' do
                        expect(site.profile.browser_cluster_ignore_images).to_not eq revision.site_profile.browser_cluster_ignore_images

                        within heading do
                            click_link 'Revert'
                        end

                        expect(site.profile.reload.browser_cluster_ignore_images).to eq revision.site_profile.browser_cluster_ignore_images
                    end
                end
            end
        end
