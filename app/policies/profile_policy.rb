class ProfilePolicy < ApplicationPolicy
    ...
    def permitted_attributes
        [
            ...
            :login_check_pattern, :login_check_url, { checks: [] }, :http_proxy_host,
            :http_proxy_password, :http_proxy_port, :http_proxy_type, :http_proxy_username,
            :http_request_redirect_limit, :scope_redundant_path_patterns,
            :scope_restrict_paths, :http_user_agent, :http_request_timeout,
            :description, :scope_https_only, :scope_exclude_path_patterns_pages,
